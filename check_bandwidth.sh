...
then
echo "CRITICAL: rx $rx_value_recal kbps tx $tx_value_recal kbps. Limit of $crit exceeded"
exit 2
else
echo "WARNING: rx $rx_value_recal kbps tx $tx_value_recal kbps. Limit of $warn exceeded"
exit 1
fi
else
echo "OK: rx $rx_value_recal kbps tx $tx_value_recal kbps"
exit 0
fi
